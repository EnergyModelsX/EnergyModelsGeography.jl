...
- `constraints_opex_var`:
  ...
  !!! tip "The function `EMB.multiple`"
      The function [``scale_op_sp(t_{inv}, t)``](@ref EnergyModelsBase.scale_op_sp) calculates the scaling factor between operational and strategic periods.
