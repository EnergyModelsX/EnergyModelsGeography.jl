...
function small_graph_co2_1()
    ...
    pipeline = PipeSimple("pipeline", CO2_150, CO2_200, Power, FixedProfile(0.1), FixedProfile(100), FixedProfile(0.05), FixedProfile(0.05), FixedProfile(0.05), 1, Dict("" => EmptyData()))
